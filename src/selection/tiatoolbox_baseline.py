"""Baseline TIAToolbox WSI patch selection.

This module implements only the reproducible baseline for INF402 Etapa 1:
TIAToolbox sliding-window extraction with Otsu tissue masking, bounded patch
export, metadata, summary JSON, method config, and preview.
"""
...
class TiatoolboxCandidate:
    """Level-0 candidate coordinate generated by TIAToolbox."""
...
def _configure_tiatoolbox_runtime() -> None:
    """Set writable cache locations before importing TIAToolbox tools."""
    os.environ.setdefault("NUMBA_CACHE_DIR", "/tmp/numba_cache")
    os.environ.setdefault("MPLCONFIGDIR", "/tmp/mpl_config")


def _import_tiatoolbox_extractor() -> tuple[type[Any], str]:
    """Import the TIAToolbox sliding-window extractor lazily."""
...
def _slide_metadata_from_extractor(extractor: object) -> dict[str, Any]:
    """Read slide metadata exposed by the TIAToolbox WSI reader."""
...
def _selected_row(
    ...
    *,
    ...
    return {
        ...
        "clinical_warning": candidate_row.get("clinical_warning", ""),
    }
